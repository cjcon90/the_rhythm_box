...
class RatingAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user_id__email', 'user_id__first_name', 'user_id__last_name', 'product__title')

class ReviewAdmin(admin.ModelAdmin):
    list_display = ('rating', 'headline', 'date_added')
    search_fields = ('rating__user_id__email', 'rating__user_id__first_name', 'rating__user_id__last_name', 'rating__product__title')
